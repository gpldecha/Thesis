...
as being part of the joint distribution.
...
In Algorithm \ref{alg:memory-motion}, we detail how an action $u_t$ and measurement $Y_t$, result in the update of $\Psi_{0:t}$, 
...
\begin{align}
 ...
 &\frac{ \sum\limits_{O} P(Y_t|A_{t},O) P_{\cap}(O;\mathcolor{red}{\ThOs}) P_{\cap}(A_t;\mathcolor{blue}{\ThAs})  P(Y_{0:t}|A_t,O,u_{1:t};\mathcolor{dark-green}{\bar{\Psi}_{0:t}})}{P(Y_{0:t}|u_{1:t};\mathcolor{dark-blue}{\Alpha})} \label{eq:marignal_mrf_2} 
\end{align}
