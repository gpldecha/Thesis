...
We demonstrate how the two different parametrisations of the joint distribution of the BN in Figure \ref{fig:bayesian_sse_dag} 
...
%The likelihood of an observation can be evaluated:
...
\begin{figure}
\centering
\subfigure{\includegraphics[width=0.4\textwidth]{./ch5-MLMF/Figures/Figure4.pdf}}
\subfigure{\includegraphics[width=0.55\textwidth]{./ch5-MLMF/Figures/Figure5.pdf}}
