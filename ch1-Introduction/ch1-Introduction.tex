...
sighting of a landmark, a term used in the Simultaneous Localisation and Mapping literature), in the case for haptic and tactile search tasks. For the mapping problem we develop a Bayesian filter which is non-parametric and has no explicit 
...
that the teacher is be an expert, with a few notable exceptions, \citep{rai2013learning}. As a result the quality of 
