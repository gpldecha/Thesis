...
\cite{bsp_rss_2010} 			% Optimal control Belief space planning assuming maximum likelihood observation (optimal control)
\cite{int_motion_planning_2013}  	% tree search planning
\cite{non_gauss_bel_plan_2012}		% Non-Gaussian belief space planning (optimisation)
\cite{Erez10ascalable},
\cite{van_den_Berg_2012}		% Optimal control in belief space planning 

\cite{active_RSS_07} 			% Active Policy Learning for robot planning and exploration under uncertainty coste function optimsation
\cite{plan_cont_bel_space_2015}		% Belief space approach to autonomous navigation
\cite{rob_online_bs_icra_2014}		% average
