...
Actor-critic \cite[Chap. 6.6]{sutton98reinforcement} is an RL approach in which the actor (policy) and critic (value function) 
...
without some form of compression. One possibility would be E-PCA \citep{NIPS2002_2319} which extracts a set of 
