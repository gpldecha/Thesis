...
%  and a plug insertion policy is learned $\pi_{\Para_2}(\U,\B)$.}
%  \label{fig:data_flow}
%\end{figure}
...
\begin{figure}
 \centering
   \subfigure[]{\includegraphics[width=0.33\textwidth]{./ch4-PiH/Figures/Fig/experiment1.pdf}}\hfill
   \subfigure[]{\includegraphics[width=0.33\textwidth]{./ch4-PiH/Figures/Fig/experiment2.pdf}}\hfill
   \subfigure[]{\includegraphics[width=0.33\textwidth]{./ch4-PiH/Figures/Fig/experiment3_plot2.pdf}}
