...
%whilst 
%controlling for the position makes sense when considering only one type of object with time dependent dynamical 
%system. If the dimensions of the object where to change, this would entail problems.
...
% use state information as we do, much easier
