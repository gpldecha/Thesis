...
\usepackage[dvips, backref,bookmarks=true, breaklinks]{hyperref} % clickable back-references from the bibliography list to citing sections
...
\hypersetup{colorlinks={true},
	...
	%\newcommand{\gDisplayCDS}{}
	%\newcommand{\gDisplayMultiAtt}{}
	%\newcommand{\gDisplayASVM}{}
	%\newcommand{\gDisplayRRT}{}
...
\ifdefined	\gDisplaySearch			\input{ch3-Search} 	 \fi
\ifdefined	\gDisplayMLMF	 		\input{ch4-MLMF}	 \fi
\ifdefined	\gDisplayPegSocket		\input{ch5-PegSocket} 	 \fi
...
\ifdefined \gDisplayBibliography
	...
	\bibliography{bib/all_citations.bib,bib/pomdp.bib,bib/ProspectTheory.bib}

	%\bibliography{bib/DT.bib,bib/pomdp.bib,bib/cpomdp.bib,bib/spatial_navigation.bib,bib/imitation_learning.bib,bib/citations.bib,bib/ToM.bib,bib/PropsectTheory.bib}
\fi
